...
Using the appropiate elements to explain to aid with accessibility, and SEO. Example would be using nav instead of assigning  a class of nav to a div.
...
It is a extremely efficient system for multiple people to work together on applications. It provides excellent version controls with branches, and forks. It also allows people to check if the their working on an up to date working trees, and with the merging system multiple people can submit a solution to the same problem, and the best can be implemented.

5. Define mobile-first design in your own words.

Designing web apps to be displayed, and interacted with on a mobile device first before building for the desktop enviroment.
